...
@RestController
@RequestMapping("/api/productorder-kafka")
public class ProductorderKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ProductorderKafkaResource.class);
    ...
    public ProductorderKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
